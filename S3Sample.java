 ...
 * (C:\\Users\\manab\\.aws\\credentials) where the sample code will load the credentials from.
 * <p>
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\manab\\.aws\\credentials), and is in valid format.",
                    e);
        }
        ...
        try {
            ...
            System.out.println("Downloading2 an object");
            object = s3.getObject(new GetObjectRequest(bucketName, key));
            System.out.println("Content-Type: "  + object.getObjectMetadata().getContentType());
            displayTextInputStream(object.getObjectContent());
            
            System.out.println("get list objects in bkt ");
